...
open class TrendingMDB: ArrayObject {
  ...
  public class func trending(language: String, mediaType: TrendingMediaType, timeWindow: TrendingTimeWindow, page: Int = 1, completionHandler: @escaping (ClientReturn, _ movieData: [MovieMDB]?, _ tvData: [TVMDB]?) -> ()) -> (){
    Client.trending(language: language, baseURL: mediaType.rawValue + "/" + timeWindow.rawValue, page: page, completion: {
          data in
